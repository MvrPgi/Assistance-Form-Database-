dbConfig = {
    ...
    'user': 'root',
    'password': '1234',
    'database': 'practice'  # PRACTICE DATABASE
}
...
#    Applicant_ID VARCHAR(10) AUTO_INCREMENT PRIMARY KEY,
...
#    Household_ID VARCHAR(10) AUTO_INCREMENT PRIMARY KEY,
...
#    Reference_No VARCHAR(15) AUTO_INCREMENT  PRIMARY KEY,
#    Applicant_ID VARCHAR(10) NOT NULL,
#    Date DATE NOT NULL,
