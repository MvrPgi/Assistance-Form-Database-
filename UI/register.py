...
#ENTRY IMAGES
        self.create_image(120.0, 150.5, image=self.image_image1_1)
        self.create_image(300.0, 200.0, image=self.image_entry1_1)
        self.create_image(166.0, 318.0, image=self.image_entry2_1)
        self.create_image(149.0, 415.0, image=self.image_entry3_1)
        self.create_image(402.0, 415.0, image=self.image_entry4_1)
        self.create_image(670.0,200.0, image=self.image_entry5_1)

#CREATE TEXT
        self.create_text(40.0, 176, anchor="nw", text="Name", fill="#000000", font=("Mada Regular", 10 * -1))
        self.create_text(40.0, 228, anchor="nw", text="Civil Status", fill="#000000", font=("Mada Regular", 10 * -1))
        self.create_text(40.0, 291, anchor="nw", text="Relation To Patient", fill="#000000", font=("Mada Regular", 10 * -1))
        self.create_text(40.0, 389, anchor="nw", text="Occupation", fill="#000000", font=("Mada Regular", 10 * -1))
        self.create_text(369.0, 292, anchor="nw", text="Highest Educational Attainment", fill="#000000", font=("Mada Regular", 10 * -1))
        self.create_text(637.0, 175, anchor="nw", text="Age", fill="#000000", font=("Mada Regular", 10 * -1))
        self.create_text(319.0, 386, anchor="nw", text="Monthly Income", fill="#000000", font=("Mada Regular", 10 * -1))
...
#RADIO BUTTON
        ...
        self.HSingle = Radiobutton(
                ...
                highlightthickness=0,
                value="Single",
                variable=self.HCivilStatus,
                font=("Mada Regular", 10 * -1)
                )
        self.HWidow = Radiobutton(
                self,
                text="Widow",
                bg="#FFFFFF",
                fg="#000716",
        ...
        self.HPost_Graduate = Radiobutton(
                self,
                text="Post Graduate",
                bg="#FFFFFF",
                fg="#000716",
                ...
                highlightthickness=0,
                value="Post Graduate",
                variable=self.HHigeshtEducationalAttainment,
                font=("Mada Regular", 10 * -1)
                )
        self.HCollege = Radiobutton(
                self,
                text="College",
                bg="#FFFFFF",
                fg="#000716",
        ...
        self.HElementary_School = Radiobutton(
                self,
                text="Elementary",
                bg="#FFFFFF",
                fg="#000716",
        ...
        self.HSeparated.place(
                x=123.0,
                y=265.5,
                width=70.0,
                height=15.0
                )
        self.HPost_Graduate.place(
                x=360.0,
                y=310.5,
                width=100.0,
                height=15.0
                )
        self.HHigh_School.place(
                x=470.0,
                y=310.5,
                width=80.0,
                height=15.0
                )
        # self.HVocational.place(
        #         x=649.0,
        #         y=320.5,
        #         width=80.0,
        #         height=15.0
        #         )
        # self.HElementary_School.place(
        #         x=569.0,
        #         y=320.5,
        #         width=80.0,
        #         height=15.0
