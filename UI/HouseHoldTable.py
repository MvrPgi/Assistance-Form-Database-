...
class AdminBenchHousehold(tk.Toplevel):
    ...
    def __init__(self, master = None,switch_frame=None):
        ...
        self.refreshButton = tk.Button(self.canvas, image=self.RefreshButtonImage, command=self.FetchHouseHoldData)
        ...
        column_widths = {
            "Household_ID": 100,"Applicant_ID":100,"Family Full Name": 150, "Family Age": 50,
