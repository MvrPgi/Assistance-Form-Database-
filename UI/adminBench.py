...
class AdminBench(tk.Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.columns = ( # Create the columns
            "Reference No","Applicant ID","Date","Applicant Status", "Full Name", "Address", "Civil Status", "BirthDate", "Age",
        ...
        column_widths = {
            "Reference No": 100, "Applicant ID": 100, "Date": 100, "Applicant Status": 150, "Full Name": 150, "Address": 300, 
