...
class Signup(tk.Canvas):
    def __init__ (self, master = None,switch_frame=None):
        ...
        self.alreadyHaveAccount = PhotoImage(file=resource_path("resources/signup/alreadyAcc_text.png"))
        ...
        self.create_image(574.0, 370.0, image=self.alreadyHaveAccount)
        ...
        self.LoginButton.place(x=668.0, y=368.5, anchor="center", width=45, height=18)
